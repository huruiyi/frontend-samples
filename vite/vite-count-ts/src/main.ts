...
export function setupCounter(element: HTMLElement) {
  ...
  //TIP In the app running in the browser, you’ll find that clicking <b>-2</b> doesn't work. To fix that, rewrite it using the code from lines 19 - 21 as examples of the logic. 已修复
