...
(function (Mankala) {
    ...
    var DisplayPosition = /** @class */ (function (_super) {
        __extends(DisplayPosition, _super);
        function DisplayPosition(seedCounts, startMove, turn) {
            var _this = _super.call(this, seedCounts, startMove, turn) || this;
            _this.config = [];
...
(function (Mankala) {
    var Rectangle = /** @class */ (function () {
        ...
        Rectangle.prototype.proportionalSplitHoriz = function () {
            ...
            for (var _i = 0; _i < arguments.length; _i++) {
                proportionalWidths[_i] = arguments[_i];
            }
        ...
        Rectangle.prototype.proportionalSplitVert = function () {
            ...
            for (var _i = 0; _i < arguments.length; _i++) {
                proportionalHeights[_i] = arguments[_i];
            }
    ...
    var Square = /** @class */ (function (_super) {
        ...
        function Square(x, y, len) {
            var _this = _super.call(this, x, y, len, len) || this;
            _this.len = len;
            return _this;
        }
        return Square;
